...
exports.default = {
     ...
     */
    sendMessage: function (webhook, message) {
        return __awaiter(this, void 0, void 0, function () {
            var formdataReq;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        formdataReq = new URLSearchParams();
                        ...
                        return [4 /*yield*/, axios_1.default.post("https://kstm.daouoffice.com/api/chat/rooms/" + webhook.roomId, formdataReq, {
                                headers: {
